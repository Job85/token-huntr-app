...
const Nav = ({ user }) => {
    return (
        <nav className='navbar'>
            ...
            <NavLink to='/locations' className='nav-anchor'><FontAwesomeIcon icon={faLocationCrosshairs} className='nav-icon' /> <FontAwesomeIcon icon={faCompass} className='nav-icon' /></NavLink>
